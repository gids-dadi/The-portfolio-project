...
for (let i = 1; i < cardDetails.length; i += 1) {
 ...
 class="button works-button">See Project</button>
            </div>          
  </div>`;
}
  ...
  popupModal.innerHTML = `
    <div class="works-popup">
        ...
        <div class="work-popup-image">
           ...
           <img src=${cardDetails[i].imagePopup} />
          <div>
          <div class= "textWrap">
           <p>${cardDetails[i].popDescription}</p>
        <div class = "d-links">
                 <a
                href="${cardDetails[i].seeLive}"
                target="_blank"
                rel="noreferrer noopener"
                ><span
                  >See Live<img  src="Icons/arrow.png" alt="live"
                /></span>
              </a>

               <a
                href="${cardDetails[i].seeSource}"
                target="_blank"
                rel="noreferrer noopener"
                ><span
                  >See Source<img
